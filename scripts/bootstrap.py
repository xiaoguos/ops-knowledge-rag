...
def main():
    ...
    password=os.getenv("BOOTSTRAP_PASSWORD") or getpass.getpass("Password (14+ characters): ")
    if not email or "@" not in email or not tenant:raise ValueError("Valid email and tenant required")
